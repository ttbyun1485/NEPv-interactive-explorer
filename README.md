...
## Local Setup
To run this project on your machine, simply click the link in live demo. No installation is required. 
...
- Lack of deep dive: This explorer only acts an intuitive platform to understand NEPv. Some deeper aspects on NEPv are missed, including other numerical methods or choices of operator.  
